...
- **[dir-config.el](https://github.com/jamescherti/dir-config.el)**: Automatically find and evaluate .dir-config.el Elisp files to configure directory-specific settings. <img align="right" alt="GitHub Repo stars" src="https://img.shields.io/github/stars/jamescherti/dir-config.el?style=social">
...
- **[flymake-bashate.el](https://github.com/jamescherti/flymake-bashate.el)**: Automatically find and evaluate .flymake-bashate.el Elisp files to configure directory-specific settings. <img align="right" alt="GitHub Repo stars" src="https://img.shields.io/github/stars/jamescherti/flymake-bashate.el?style=social">
